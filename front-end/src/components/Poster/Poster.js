    ...
    <>
      <div className={PosterStyle.PosterContainer}>
        <div className={PosterStyle.MainContent}>
          <div className={PosterStyle.Quote}>
            Making Burgers customized <br /> to YOUR taste buds
          </div>
          <button
            className={PosterStyle.OrderButton}
            onClick={() =>
              document
                .getElementById("BuildBurger")
      ...
      <div className={PosterStyle.Specialities}>
        <div className={PosterStyle.feature}>
          ...
          <img
            ...
            alt="delivery van"
          />
          <div className={PosterStyle.Content}>
            Delivery within 30 minutes of order
          </div>
        </div>
        <div className={PosterStyle.feature}>
          <div className={PosterStyle.Title}>
            Customizable to the granular level
          </div>
          <img
            src={Customize}
            style={{
        ...
        <div className={PosterStyle.feature}>
          ...
          />
          <div className={PosterStyle.Content}>
            Each ingredient is carefully handpicked by following all food
            standards
          </div>
        </div>
      </div>
